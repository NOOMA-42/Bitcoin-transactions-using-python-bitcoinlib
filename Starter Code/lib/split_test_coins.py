...
if __name__ == '__main__':
    ...
    private_key = my_private_key # remember to set this param
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.001 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        '0b6c01c29a688b195ea8a35921b027632c224f899cdd4dea683ec185e5f2a6c5')
    utxo_index = 1 # index of the output you are spending, indices start at 0. Note: check Tx at live.blockcypher, there are two outputs 
